...
>(({ className, ...props }, ref) => (
    ...
    >
        <SwitchPrimitive.Thumb
            className={cn(
                "pointer-events-none block h-5 w-5 rounded-full border border-border/80 ring-0 transition-transform shadow-sm",
                "data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0",
                "data-[state=checked]:bg-background data-[state=unchecked]:bg-card"
            )}
        />
    </SwitchPrimitive.Root>
))
